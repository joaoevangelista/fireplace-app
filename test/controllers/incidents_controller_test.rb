...
class IncidentsControllerTest < ActionController::TestCase
  ...
  test 'should create incident' do
    assert_difference('Incident.count') do
      post :create, incident: {
        ...
        description: @incident.description, incident_type_id: @incident.incident_type_id,
        location: @incident.location, open: @incident.open,
  ...
  test 'should update incident' do
    patch :update, id: @incident, incident: {
      action_taken: @incident.action_taken, description: @incident.description,
      incident_type_id: @incident.incident_type_id, location: @incident.location,
      open: @incident.open, user_id: @incident.user_id
    }
    assert_redirected_to incident_path(assigns(:incident))
  end
